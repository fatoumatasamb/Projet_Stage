import EnseignantMateriels from './pages/enseignant/Materiels'
    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          <Route path="/verifier-email/:id/:hash" element={<VerifyEmail />} />
          ...
          <Route path="/enseignant/notes" element={<ProtectedRoute roles={['enseignant']}><EnseignantComptesRendus /></ProtectedRoute>} />
           ...
           <Route path="/enseignant/materiels" element={<ProtectedRoute roles={['enseignant']}><EnseignantMateriels /></ProtectedRoute>} />
